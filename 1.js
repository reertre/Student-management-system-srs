...
function onEdit(td) {
    ...
    document.getElementById("fee").value = selectedRow.cells[5].innerHTML;
    document.getElementById("eroll").value = selectedRow.cells[6].innerHTML;
    document.getElementById("exam").value = selectedRow.cells[7].innerHTML;
}
// Update Record
